...
export function CappyComposer({ disabled, onSend }: { disabled: boolean; onSend: (content: string) => void }) {
  ...
  return (
    <div className="flex items-end gap-2 rounded-[26px] border bg-background p-2 pl-4 shadow-sm transition-shadow focus-within:shadow-md">
      <Textarea
        ...
        placeholder={disabled ? "Cappy is thinking…" : "Ask Cappy to research, analyze, or track anything…"}
        disabled={disabled}
        rows={1}
