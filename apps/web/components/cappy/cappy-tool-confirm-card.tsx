...
import type { CappyToolCallView } from "./types";
...
export function CappyToolConfirmCard({
  call,
  onRespond,
}: {
  call: CappyToolCallView;
  ...
  if (call.status !== "pending_confirmation") {
    ...
    // - shown as a small inline note, not a card, by cappy-message-list.tsx.
    return null;
  }
